$(document).ready(function() {
  ...
  test('reduce', function() {
    ...
    var negativeSum = _.reduce([1, 2, 3], function(negativeSum, num){ return negativeSum - num; }, 0);
    equal(negativeSum, -6, 'can negativeSum up an array');
